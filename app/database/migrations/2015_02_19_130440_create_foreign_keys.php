...
class CreateForeignKeys extends Migration {
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE `following` ADD CONSTRAINT `following_series_id_foreign` FOREIGN KEY (`series_id`) REFERENCES `series` (`id`) ON DELETE CASCADE,
                                               ADD CONSTRAINT `following_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE;');
        ...
        DB::statement('ALTER TABLE `seen` ADD CONSTRAINT `seen_episode_id_foreign` FOREIGN KEY (`episode_id`) REFERENCES `episode` (`id`) ON DELETE CASCADE,
                                          ADD CONSTRAINT `seen_series_id_foreign` FOREIGN KEY (`series_id`) REFERENCES `series` (`id`) ON DELETE CASCADE,
                                          ADD CONSTRAINT `seen_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE;');
